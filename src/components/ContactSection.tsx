          ...
          <Card className="bg-card/80 backdrop-blur-sm border-0 shadow-brand">
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium mb-2">Company/App Name</label>
                    <Input
                      name="company"
          ...
          <div className="space-y-8">
            ...
            <Card className="bg-gradient-primary/10 backdrop-blur-sm border border-primary/20">
              <CardContent className="p-8 text-center">
                <h4 className="text-xl font-bold mb-4">Prefer a quick call?</h4>
                <p className="text-muted-foreground mb-6">
                  Schedule a 15-minute demo to see how Appladder can transform your app growth.
                </p>
