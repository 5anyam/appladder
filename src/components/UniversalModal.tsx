...
const BrandLogo: React.FC = () => (
  <div className="flex items-center gap-2">
    ...
    <span className="text-xl font-bold text-[#242878]">Appladder</span>
  </div>
);
...
const ExampleWithModalButton: React.FC = () => {
  ...
  return (
    <>
      <button
        className="px-8 py-3 rounded-full bg-[#00F0FF] text-[#242878] font-bold shadow hover:bg-[#3a3ad9] hover:text-white transition"
